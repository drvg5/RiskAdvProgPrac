...
public class RiskTest extends TestCase {
	...
	public void testCalcReinforcementArmies()
	{
		...
		armies = ReinforcementPhase.calculateReinforcement("2");
		assertEquals(armies,ReinforcementPhase.calculateReinforcement("2"));
		armies = ReinforcementPhase.calculateReinforcement("3");
		assertEquals(armies,ReinforcementPhase.calculateReinforcement("3"));
		armies = ReinforcementPhase.calculateReinforcement("4");
		assertEquals(armies,ReinforcementPhase.calculateReinforcement("4"));
	}
