...
public class StartUpPhase {
	...
	/**
	 * This method populates {@link StartUpPhase#countryTaken} TreeSet and
	 * {@link StartUpPhase#terrCont} HashMap and HashMap to Number of Territories
	 * per Continent
	 * <p>
	 * This method calls method {@link StartUpPhase#terrPerPlayerPopulate} to
	 * populate the {@link StartUpPhase#terrPerPlayer} HashMap and then calls
	 * {@link StartUpPhase#assignTerritories} to assign territories randomly
	 * </p>
	 * 
	 ...
	 * {@link StartUpPhase#playerInfo} HashMap
	 * <p>
	 ...
	 * these to appropriate places in the {@link StartUpPhase#playerInfo} HashMap
	 * <p>
